    ...
    static void Main(string[] args)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < 9999; i++)
            {
                ...
                if (args[0].Equals("D1F") && (i == 5000))
                {
                    PadiDstm.Fail("tcp://localhost:2001/Server");
                }
                sum += pi_a.Read();
            }
            Console.WriteLine("sum= " + sum);
            if (args[0].Equals("D1") || args[0].Equals("D1F"))
            {
        ...
        try
        {
            ...
            int g = pi_g.Read();
            PadInt pi_h = PadiDstm.AccessPadInt(10001);
            int h = pi_h.Read();
            res = PadiDstm.TxCommit();
            Console.WriteLine("####################################################################");
            Console.WriteLine("sum D1 = " + g);
            Console.WriteLine("sum D2 = " + h);
